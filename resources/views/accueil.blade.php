  ...
  <div class="hero_area">
    ...
    <div class="hero_bg_box">
      <div class="bg_img_box">
        <img src="assets/frontend/images/hero-bg.png" alt="">
      </div>
    </div>
          ...
          <div class="carousel-item active">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="assets/frontend/images/slider-img.png" alt="">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container ">
        ...
        <div class="row">
          <div class="col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="assets/frontend/images/s1.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Currency Wallet
          ...
          <div class="col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="assets/frontend/images/s2.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Security Storage
          ...
          <div class="col-md-4 ">
            <div class="box ">
              <div class="img-box">
                <img src="assets/frontend/images/s3.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Expert Support
  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="assets/frontend/images/about-img.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
  ...
  <section class="why_section layout_padding">
    <div class="container">
      ...
      <div class="why_container">
        ...
        <div class="box">
          <div class="img-box">
            <img src="assets/frontend/images/w4.png" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Happy Customers
      ...
      <div class="team_container">
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="assets/frontend/images/team-1.jpg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Joseph Brown
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="assets/frontend/images/team-2.jpg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Nancy White
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="assets/frontend/images/team-3.jpg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Earl Martinez
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="assets/frontend/images/team-4.jpg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Josephine Allard
      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="assets/frontend/images/client1.jpg" alt="" class="box-img">
              </div>
              <div class="detail-box">
                <div class="client_id">
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="assets/frontend/images/client2.jpg" alt="" class="box-img">
              </div>
              <div class="detail-box">
                <div class="client_id">
                  <div class="client_info">
